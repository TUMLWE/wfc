...
SINT32  offset1_AppEOI(VOID);
VOID    offset1_AppDeinit(VOID);
SINT32  offset1_CfgRead(VOID);
SINT32  offset1_SviSrvInit(VOID);
VOID    offset1_SviSrvDeinit(VOID);

/* Functions: administration, to be called only from within this file */
MLOCAL VOID offset1_CfgInit(VOID);
...
OFFSET1_BASE_PARMS offset1_BaseParams;
...
REAL64 hostwfc_INFLW1WSFiltered[1];
MLOCAL SVI_ADDR SA_hostwfc_INFLW1WSFiltered;
REAL64 hostwfc_INFLW1WdirFiltered[1];
MLOCAL SVI_ADDR SA_hostwfc_INFLW1WdirFiltered;
REAL64 hostwfc_INFLW1TurbIntFiltered[1];
MLOCAL SVI_ADDR SA_hostwfc_INFLW1TurbIntFiltered;
REAL64 hostwfc_INFLW1ShearExpFiltered[1];
MLOCAL SVI_ADDR SA_hostwfc_INFLW1ShearExpFiltered;
REAL64 hostwfc_INFLW1OK[1];
MLOCAL SVI_ADDR SA_hostwfc_INFLW1OK;
REAL64 hostwfc_OFFSET1Offsetdeg[1];
MLOCAL SVI_ADDR SA_hostwfc_OFFSET1Offsetdeg;
REAL64 hostwfc_OFFSET1OK[1];
MLOCAL SVI_ADDR SA_hostwfc_OFFSET1OK;
...
MLOCAL REAL64 input_WS_Filtered_ms=0;
MLOCAL REAL64 input_WDir_Filtered_deg=0;
MLOCAL REAL64 input_TI_Filtered=0;
MLOCAL REAL64 input_ShearExp_Filtered=0;
MLOCAL REAL64 input_inflowOK=0;
MLOCAL REAL64 output_Offset_deg=0;
MLOCAL REAL64 output_OK=0;
...
MLOCAL TASK_PROPERTIES TaskProperties_aControl = {
    "aOFFSET1_Ctrl",                 /* unique task name, maximum length 14 */
...
MLOCAL SVI_GLOBVAR SviGlobVarList[] = {
    {"CycleCounter", SVI_F_INOUT | SVI_F_UINT32, sizeof(UINT32), (UINT32 *) & CycleCount, 0, NULL,
     NULL}
    ,
    {"ModuleVersion", SVI_F_OUT | SVI_F_STRING, sizeof(offset1_Version),
     (UINT32 *) offset1_Version, 0, NULL, NULL},

// MATLABCODEGEN: OpenField SVI Variables Coupling

{"input_WS_Filtered_ms", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &input_WS_Filtered_ms, 0, NULL, NULL},
{"input_WDir_Filtered_deg", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &input_WDir_Filtered_deg, 0, NULL, NULL},
{"input_TI_Filtered", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &input_TI_Filtered, 0, NULL, NULL},
{"input_ShearExp_Filtered", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &input_ShearExp_Filtered, 0, NULL, NULL},
{"input_inflowOK", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &input_inflowOK, 0, NULL, NULL},
{"output_Offset_deg", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &output_Offset_deg, 0, NULL, NULL},
{"output_OK", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &output_OK, 0, NULL, NULL},
...
input_WS_Filtered_ms = hostwfc_INFLW1WSFiltered[0];
input_WDir_Filtered_deg = hostwfc_INFLW1WdirFiltered[0];
input_TI_Filtered = hostwfc_INFLW1TurbIntFiltered[0];
input_ShearExp_Filtered = hostwfc_INFLW1ShearExpFiltered[0];
input_inflowOK = hostwfc_INFLW1OK[0];
...
OFFSET_1_U.input_WS_Filtered_ms =  input_WS_Filtered_ms;
OFFSET_1_U.input_WDir_Filtered_deg =  input_WDir_Filtered_deg;
OFFSET_1_U.input_TI_Filtered =  input_TI_Filtered;
OFFSET_1_U.input_ShearExp_Filtered =  input_ShearExp_Filtered;
OFFSET_1_U.input_inflowOK =  input_inflowOK;
...
output_Offset_deg =  OFFSET_1_Y.output_Offset_deg;
output_OK =  OFFSET_1_Y.output_OK;

// MATLABCODEGEN: CloseField Output Variable Assignment

// MATLABCODEGEN: OpenField Assign ITF output Variables to HOST SVI

hostwfc_OFFSET1Offsetdeg[0] = output_Offset_deg;
hostwfc_OFFSET1OK[0] = output_OK;
...
SINT32 offset1_AppEOI(VOID)
{
    ...
    do
    {
        ...
        snprintf(offset1_ModuleInfoDesc, sizeof(offset1_ModuleInfoDesc), "TODO: set application specific module info string");
...
*        For general configuration data, offset1_CfgParams is being used.
*        Being called by offset1_CfgRead.
...
MLOCAL SINT32 Task_CfgRead(VOID)
{
    ...
    snprintf(section, sizeof(section), offset1_BaseParams.AppName);
    ...
    for (idx = 0; idx < NbOfTasks; idx++)
    {
        ...
        ret = pf_GetStrg(section, group, key, "", (CHAR *) & TmpStrg, sizeof(TmpStrg),
                         offset1_BaseParams.CfgLine, offset1_BaseParams.CfgFileName);
        ...
        else
        {
            ...
            {
                TaskList[idx]->Priority = offset1_BaseParams.DefaultPriority;
...
MLOCAL SINT32 Task_CreateAll(VOID)
{
    ...
    for (idx = 0; idx < NbOfTasks; idx++)
    {
        ...
        if (TaskList[idx]->WDogRatio > 0)
        {
            ...
            TaskList[idx]->WdogId = sys_WdogCreate(offset1_AppName, wdogtime_us);
        ...
        if (strlen(TaskList[idx]->Name) < 1)
            snprintf(TaskList[idx]->Name, sizeof(TaskList[idx]->Name), "a%s_%d", offset1_AppName, idx + 1);
        ...
        TaskList[idx]->TaskId = sys_TaskSpawn(offset1_AppName, TaskName,
...
MLOCAL VOID Task_DeleteAll(VOID)
{
    ...
    do
    {
        ...
        if (AllTasksQuitted)
        {
            if (offset1_BaseParams.DebugMode & APP_DBG_INFO1)
...
MLOCAL SINT32 Task_InitTiming_Sync(TASK_PROPERTIES * pTaskData)
{
    ...
    pTaskData->SyncSessionId = mio_StartSyncSession(offset1_AppName);
...
MLOCAL VOID Task_WaitCycle(TASK_PROPERTIES * pTaskData)
{
     ...
     */
    if ((offset1_ModState == RES_S_STOP) || (offset1_ModState == RES_S_EOI))
    {
         ...
         */
        semTake(offset1_StateSema, WAIT_FOREVER);
    }
}
...
MLOCAL VOID offset1_CfgInit(VOID)
{
    ...
    strncpy(offset1_BaseParams.CfgFileName, offset1_ProfileName, M_PATHLEN);

    /* Application name */
    strncpy(offset1_BaseParams.AppName, offset1_AppName, M_MODNAMELEN);

    /* Line number in configuration file (used as start line for searching) */
    offset1_BaseParams.CfgLine = offset1_CfgLine;

    /* Worker task priority from module base parameters (BaseParms) */
    offset1_BaseParams.DefaultPriority = offset1_AppPrio;

    /* Debug mode from module base parameters (BaseParms) */
    offset1_BaseParams.DebugMode = offset1_Debug;
...
SINT32 offset1_SviSrvInit(VOID)
{
    ...
    UINT32  i;
    CHAR    Func[] = "offset1_SviSrvInit";

    /* If there are any SVI variables to be exported */
    if (NbOfGlobVars)
    {
        /* Initialize SVI-handler */
        offset1_SviHandle = svi_Init(offset1_AppName, 0, 0);
        if (!offset1_SviHandle)
        {
    ...
    {
        ret = svi_AddGlobVar(offset1_SviHandle, SviGlobVarList[i].VarName,
...
/**
********************************************************************************
* @brief Frees SVI server resources according to offset1_SviSrvInit()
...
VOID offset1_SviSrvDeinit(VOID)
{
    ...
    if (svi_DeInit(offset1_SviHandle) < 0)
        LOG_E(0, "offset1_SviSrvDeinit", "Could not de-initialize SVI server");
...
if (svi_GetAddr(pSviLib_hostwfc, "INFLW1_WS_Filtered", &SA_hostwfc_INFLW1WSFiltered, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value hostwfc_INFLW1WSFiltered!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hostwfc, "INFLW1_Wdir_Filtered", &SA_hostwfc_INFLW1WdirFiltered, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value hostwfc_INFLW1WdirFiltered!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hostwfc, "INFLW1_TurbInt_Filtered", &SA_hostwfc_INFLW1TurbIntFiltered, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value hostwfc_INFLW1TurbIntFiltered!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hostwfc, "INFLW1_ShearExp_Filtered", &SA_hostwfc_INFLW1ShearExpFiltered, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value hostwfc_INFLW1ShearExpFiltered!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hostwfc, "INFLW1_OK", &SA_hostwfc_INFLW1OK, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value hostwfc_INFLW1OK!");
    return (ERROR);
}
...
if (svi_GetAddr(pSviLib_hostwfc, "OFFSET1_OK", &SA_hostwfc_OFFSET1OK, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value hostwfc_OFFSET1OK!");
    return (ERROR);
}

// MATLABCODEGEN: CloseField Get ITF SA Address

if (svi_GetAddr(pSviLib_hostwfc, "OFFSET1_Status", &SA_AppStatus, &SviFormat) != SVI_E_OK)
{
...
UINT32 hostwfc_INFLW1WSFiltered_size = sizeof(hostwfc_INFLW1WSFiltered);
UINT32 hostwfc_INFLW1WdirFiltered_size = sizeof(hostwfc_INFLW1WdirFiltered);
UINT32 hostwfc_INFLW1TurbIntFiltered_size = sizeof(hostwfc_INFLW1TurbIntFiltered);
UINT32 hostwfc_INFLW1ShearExpFiltered_size = sizeof(hostwfc_INFLW1ShearExpFiltered);
UINT32 hostwfc_INFLW1OK_size = sizeof(hostwfc_INFLW1OK);
...
ret = svi_GetBlk(pSviLib_hostwfc, SA_hostwfc_INFLW1WSFiltered, (UINT32*) &hostwfc_INFLW1WSFiltered,  &hostwfc_INFLW1WSFiltered_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value hostwfc_INFLW1WSFiltered!");
ret = svi_GetBlk(pSviLib_hostwfc, SA_hostwfc_INFLW1WdirFiltered, (UINT32*) &hostwfc_INFLW1WdirFiltered,  &hostwfc_INFLW1WdirFiltered_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value hostwfc_INFLW1WdirFiltered!");
ret = svi_GetBlk(pSviLib_hostwfc, SA_hostwfc_INFLW1TurbIntFiltered, (UINT32*) &hostwfc_INFLW1TurbIntFiltered,  &hostwfc_INFLW1TurbIntFiltered_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value hostwfc_INFLW1TurbIntFiltered!");
ret = svi_GetBlk(pSviLib_hostwfc, SA_hostwfc_INFLW1ShearExpFiltered, (UINT32*) &hostwfc_INFLW1ShearExpFiltered,  &hostwfc_INFLW1ShearExpFiltered_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value hostwfc_INFLW1ShearExpFiltered!");
ret = svi_GetBlk(pSviLib_hostwfc, SA_hostwfc_INFLW1OK, (UINT32*) &hostwfc_INFLW1OK,  &hostwfc_INFLW1OK_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value hostwfc_INFLW1OK!");
...
ret = svi_SetBlk(pSviLib_hostwfc, SA_hostwfc_OFFSET1Offsetdeg, (UINT32*) &hostwfc_OFFSET1Offsetdeg, sizeof(hostwfc_OFFSET1Offsetdeg) );
if (ret != SVI_E_OK)
     LOG_W(0, "SviClt_Write", "Could not read value hostwfc_OFFSET1Offsetdeg!");

ret = svi_SetBlk(pSviLib_hostwfc, SA_hostwfc_OFFSET1OK, (UINT32*) &hostwfc_OFFSET1OK, sizeof(hostwfc_OFFSET1OK) );
if (ret != SVI_E_OK)
     LOG_W(0, "SviClt_Write", "Could not read value hostwfc_OFFSET1OK!");
