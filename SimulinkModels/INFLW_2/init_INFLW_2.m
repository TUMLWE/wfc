function init_INFLW_2(params_filename)%this is the initialization file for the INFLW_2 Simulink model, here you can specify constants and variables necessary for running and compiling your model 
