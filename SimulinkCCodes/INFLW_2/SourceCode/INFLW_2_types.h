...
#ifndef RTW_HEADER_INFLW_2_types_h_
#define RTW_HEADER_INFLW_2_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_wrap_INFLW_2_T
#define typedef_cell_wrap_INFLW_2_T

typedef struct tag_BlgwLpgj2bjudmbmVKWwDE cell_wrap_INFLW_2_T;

#endif                                 /* typedef_cell_wrap_INFLW_2_T */
...
struct tag_rKScUQSS6qN2Sp349o0TPC
{
  ...
  cell_wrap_INFLW_2_T inputVarSize;
...
#ifndef typedef_g_dsp_internal_SlidingWind_me_T
#define typedef_g_dsp_internal_SlidingWind_me_T

typedef struct tag_mc80LTkxA91dajiaRpnwiF g_dsp_internal_SlidingWind_me_T;

#endif                             /* typedef_g_dsp_internal_SlidingWind_me_T */
...
#ifndef typedef_g_dsp_internal_SlidingWin_meu_T
#define typedef_g_dsp_internal_SlidingWin_meu_T

typedef struct tag_uuKGx9UEdnOnhqLoPxYEkC g_dsp_internal_SlidingWin_meu_T;

#endif                             /* typedef_g_dsp_internal_SlidingWin_meu_T */
...
struct tag_IYErJ6Xqcp0jBI50a9ajyF
{
  ...
  boolean_T TunablePropsChanged;
  cell_wrap_INFLW_2_T inputVarSize;
  g_dsp_internal_SlidingWind_me_T *pStatistic;
  int32_T NumChannels;
  int32_T FrameLength;
  g_dsp_internal_SlidingWind_me_T _pobj0;
};
...
struct tag_0cC6za4GUjuHxkpgef1ylC
{
  ...
  boolean_T TunablePropsChanged;
  cell_wrap_INFLW_2_T inputVarSize;
  g_dsp_internal_SlidingWin_meu_T *pStatistic;
  int32_T NumChannels;
  int32_T FrameLength;
  g_dsp_internal_SlidingWin_meu_T _pobj0;
};

#endif                                 /* struct_tag_0cC6za4GUjuHxkpgef1ylC */

#ifndef typedef_dsp_simulink_MovingAverage_me_T
#define typedef_dsp_simulink_MovingAverage_me_T

typedef struct tag_0cC6za4GUjuHxkpgef1ylC dsp_simulink_MovingAverage_me_T;

#endif                             /* typedef_dsp_simulink_MovingAverage_me_T */

/* Forward declaration for rtModel */
typedef struct tag_RTM_INFLW_2_T RT_MODEL_INFLW_2_T;

#endif                                 /* RTW_HEADER_INFLW_2_types_h_ */
