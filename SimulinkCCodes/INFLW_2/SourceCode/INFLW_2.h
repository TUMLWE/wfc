...
#ifndef RTW_HEADER_INFLW_2_h_
#define RTW_HEADER_INFLW_2_h_
#ifndef INFLW_2_COMMON_INCLUDES_
#define INFLW_2_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* INFLW_2_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  real_T x_k[600];
  B_MovingAverage5_INFLW_2_T MovingAverage5_pn;/* '<S6>/Moving Average5' */
  B_MovingStandardDeviation1_IN_T MovingStandardDeviation1_p;/* '<S6>/Moving Standard Deviation1' */
  B_MovingAverage5_INFLW_2_T MovingAverage5_p;/* '<S6>/Moving Average5' */
  B_MovingStandardDeviation1_IN_T MovingStandardDeviation1;/* '<S6>/Moving Standard Deviation1' */
  B_MovingAverage5_INFLW_2_T MovingAverage5;/* '<S6>/Moving Average5' */
  B_MovingAverage2_INFLW_2_T MovingAverage3;/* '<Root>/Moving Average2' */
  B_MovingAverage2_INFLW_2_T MovingAverage2;/* '<Root>/Moving Average2' */
} B_INFLW_2_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  dsp_simulink_MovingStandard_m_T obj; /* '<Root>/Moving Standard Deviation' */
  dsp_simulink_MovingAverage_me_T obj_p;/* '<S9>/Moving Average1' */
  ...
  DW_MovingAverage5_INFLW_2_T MovingAverage5_pn;/* '<S6>/Moving Average5' */
  DW_MovingStandardDeviation1_I_T MovingStandardDeviation1_p;/* '<S6>/Moving Standard Deviation1' */
  DW_MovingAverage5_INFLW_2_T MovingAverage5_p;/* '<S6>/Moving Average5' */
  DW_MovingStandardDeviation1_I_T MovingStandardDeviation1;/* '<S6>/Moving Standard Deviation1' */
  DW_MovingAverage5_INFLW_2_T MovingAverage5;/* '<S6>/Moving Average5' */
  DW_MovingAverage2_INFLW_2_T MovingAverage3;/* '<Root>/Moving Average2' */
  DW_MovingAverage2_INFLW_2_T MovingAverage2;/* '<Root>/Moving Average2' */
} DW_INFLW_2_T;
...
struct tag_RTM_INFLW_2_T {
  const char_T * volatile errorStatus;
};

/* Block signals (default storage) */
extern B_INFLW_2_T INFLW_2_B;

/* Block states (default storage) */
extern DW_INFLW_2_T INFLW_2_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_INFLW_2_T INFLW_2_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_INFLW_2_T INFLW_2_Y;

/* Model entry point functions */
extern void INFLW_2_initialize(void);
extern void INFLW_2_step(void);
extern void INFLW_2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_INFLW_2_T *const INFLW_2_M;
 ...
 *
 * '<Root>' : 'INFLW_2'
 * '<S1>'   : 'INFLW_2/MATLAB Function'
 * '<S2>'   : 'INFLW_2/Subsystem'
 * '<S3>'   : 'INFLW_2/Subsystem1'
 * '<S4>'   : 'INFLW_2/Subsystem2'
 * '<S5>'   : 'INFLW_2/Subsystem3'
 * '<S6>'   : 'INFLW_2/Subsystem4'
 * '<S7>'   : 'INFLW_2/Subsystem5'
 * '<S8>'   : 'INFLW_2/Subsystem6'
 * '<S9>'   : 'INFLW_2/Subsystem7'
 * '<S10>'  : 'INFLW_2/Subsystem/Subsystem'
 * '<S11>'  : 'INFLW_2/Subsystem/Subsystem1'
 * '<S12>'  : 'INFLW_2/Subsystem/Subsystem/Subsystem1'
 * '<S13>'  : 'INFLW_2/Subsystem/Subsystem/Subsystem1/Compare To Zero'
 * '<S14>'  : 'INFLW_2/Subsystem/Subsystem1/Compare To Zero'
 * '<S15>'  : 'INFLW_2/Subsystem1/Subsystem1'
 * '<S16>'  : 'INFLW_2/Subsystem1/Subsystem1/Compare To Zero'
 * '<S17>'  : 'INFLW_2/Subsystem2/Subsystem1'
 * '<S18>'  : 'INFLW_2/Subsystem2/Subsystem1/Compare To Zero'
 * '<S19>'  : 'INFLW_2/Subsystem3/Subsystem1'
 * '<S20>'  : 'INFLW_2/Subsystem3/Subsystem1/Compare To Zero'
 * '<S21>'  : 'INFLW_2/Subsystem4/Saturation Dynamic'
 * '<S22>'  : 'INFLW_2/Subsystem4/Subsystem4'
 * '<S23>'  : 'INFLW_2/Subsystem4/Subsystem5'
 * '<S24>'  : 'INFLW_2/Subsystem4/Subsystem4/Compare To Constant'
 * '<S25>'  : 'INFLW_2/Subsystem4/Subsystem5/Compare To Constant'
 * '<S26>'  : 'INFLW_2/Subsystem5/Saturation Dynamic'
 * '<S27>'  : 'INFLW_2/Subsystem5/Subsystem4'
 * '<S28>'  : 'INFLW_2/Subsystem5/Subsystem5'
 * '<S29>'  : 'INFLW_2/Subsystem5/Subsystem4/Compare To Constant'
 * '<S30>'  : 'INFLW_2/Subsystem5/Subsystem5/Compare To Constant'
 * '<S31>'  : 'INFLW_2/Subsystem6/Saturation Dynamic'
 * '<S32>'  : 'INFLW_2/Subsystem6/Subsystem4'
 * '<S33>'  : 'INFLW_2/Subsystem6/Subsystem5'
 * '<S34>'  : 'INFLW_2/Subsystem6/Subsystem4/Compare To Constant'
 * '<S35>'  : 'INFLW_2/Subsystem6/Subsystem5/Compare To Constant'
 */
#endif                                 /* RTW_HEADER_INFLW_2_h_ */
