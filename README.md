...
This repository is an extension of PAL, a Matlab-based framework for the development, deployment, and testing of interconnected PLC applications ([GitHub Link](https://github.com/TUMLWE/PAL)). Before using this repository, an user is recommended to have familiarized with PAL following the provided examples. An in-depth documentation is hosted on Read the Docs: [PAL Documentation](https://tumlwepal-rtd.readthedocs.io/en/latest/index.html). 
